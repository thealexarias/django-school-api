...
class Student(models.Model):
    name = models.CharField(null=False, unique=False, default=None, validators=[validate_name_format])
    student_email = models.EmailField(null=False, unique=True, default=None, validators=[validate_school_email])
    ...
    locker_combination = models.CharField(null=False, unique=False, default="12-12-12", validators=[validate_combination_format])
